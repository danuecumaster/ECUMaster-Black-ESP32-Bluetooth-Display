...
document.getElementById('file').addEventListener('change', e => {
	Papa.parse(e.target.files[0], {
		...
		complete: res => {
			...
			Plotly.newPlot(plot,[
				{x:t,y:map,line:{color:'#3498db', shape:'spline', smoothing:1.3}},
				{x:t,y:rpm,yaxis:'y2',line:{color:'#e74c3c', shape:'spline', smoothing:1.3}},

				{x:t,y:tps,yaxis:'y3',line:{color:'#9b59b6', shape:'spline', smoothing:1.3}},
				{x:t,y:afr,yaxis:'y4',line:{color:'#2ecc71', shape:'spline', smoothing:1.3}},

				{x:t,y:ign,yaxis:'y5',line:{color:'#f1c40f', shape:'spline', smoothing:1.3}},
				{x:t,y:inj,yaxis:'y6',line:{color:'#e67e22', shape:'spline', smoothing:1.3}},

				{x:t,y:clt,yaxis:'y7',line:{color:'#1abc9c', shape:'spline', smoothing:1.3}},
				{x:t,y:spd,yaxis:'y8',line:{color:'#ecf0f1', shape:'spline', smoothing:1.3}}
			],{
				height:950,
				hovermode:false,
				showlegend:false,

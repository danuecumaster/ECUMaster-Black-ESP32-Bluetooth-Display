...
#else
uint8_t address[6] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; //Update with your MAC address
#endif
...
void connectToBt() {
  ...
  update_bt_icon_color(SerialBT.hasClient());
}
...
void update_bt_icon_color(bool is_connected) {
